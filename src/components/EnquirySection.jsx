...
export default function EnquirySection() {
  ...
  return (
    <section id="enquiry" className="w-full bg-white py-20 md:py-28 lg:py-32 border-b border-[#eeeeee]">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-16">
        {/* Section Header */}
        <div className="max-w-4xl mb-12 md:mb-16">
          <h2 className="text-4xl sm:text-6xl md:text-7xl lg:text-[76px] font-light tracking-[-0.035em] text-[#111111] leading-[1.06] mb-6">
            LET'S FIND THE RIGHT
            <br />
            <span className="font-normal">HUMIDITY SOLUTION.</span>
          </h2>
          <p className="text-lg sm:text-xl text-[#555555] font-normal max-w-2xl leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
          ...
          <div className="lg:col-span-7">
            {submitted ? (
              <div className="p-10 border border-[#111111] bg-[#fafafa] space-y-4 animate-fadeIn">
                ...
                <div className="pt-4">
                  <button
                    ...
                    className="text-[13px] font-medium tracking-wider uppercase text-[#111111] border-b border-[#111111] pb-0.5 hover:text-[#666666]"
                  >
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="pt-4">
                  <button
                    type="submit"
                    disabled={submitting}
                    className="w-full sm:w-auto inline-flex items-center justify-center gap-3 bg-[#111111] text-white text-[14px] font-medium tracking-[0.08em] uppercase px-10 py-4 rounded-md transition-all duration-200 hover:bg-[#2b2b2b] active:scale-[0.98] disabled:opacity-50"
                  >
          ...
          {/* Beside the form: Humidity Solutions Contact Info (5 Columns) */}
          <div className="lg:col-span-5 lg:pl-8 space-y-10 border-t lg:border-t-0 lg:border-l border-[#eeeeee] pt-10 lg:pt-0">
            <div>
